...
const projects = [
  {
    id: 1,
    title: 'Min Första Webbapp',
    description: 'En enkel applikation byggd med React och Tailwind CSS. Den visar upp grundläggande komponenter och state management.',
